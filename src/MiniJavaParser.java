...
public class MiniJavaParser/*@bgen(jjtree)*/implements MiniJavaParserTreeConstants, MiniJavaParserConstants {/*@bgen(jjtree)*/
  protected static JJTMiniJavaParserState jjtree = new JJTMiniJavaParserState();public static void main(String args[]) {
...
//}
  final public 
void Exp() throws ParseException {/*@bgen(jjtree) Exp */
...
// Eliminate left recursion
  final public void ExpPrim() throws ParseException {/*@bgen(jjtree) ExpPrim */
  SimpleNode jjtn000 = new SimpleNode(JJTEXPPRIM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (jjtc000) {
  ...
  final public void Op() throws ParseException {/*@bgen(jjtree) Op */
